...
class Library(dict):
    ...
    def search(self, searchdata):
        ret = [book.to_dict() for book in self['books'].values() if searchdata == str(book.id) or searchdata in book.title.split() or searchdata in book.author.split() or searchdata == str(book.years)]
